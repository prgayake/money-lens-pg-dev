...
const FinancialDashboard = ({ sessionId }) => {
  ...
  const categorizeTransaction = useCallback((description) => {
    ...
    if (desc.includes('food') || desc.includes('restaurant') || desc.includes('dining') || desc.includes('grocery')) return "Food";
    if (desc.includes('fuel') || desc.includes('petrol') || desc.includes('transport') || desc.includes('uber')) return "Transportation";
    if (desc.includes('shopping') || desc.includes('store') || desc.includes('mart') || desc.includes('amazon')) return "Shopping";
    if (desc.includes('entertainment') || desc.includes('movie') || desc.includes('game') || desc.includes('netflix')) return "Entertainment";
    if (desc.includes('rent') || desc.includes('utility') || desc.includes('bill') || desc.includes('electricity')) return "Bills";
    if (desc.includes('salary') || desc.includes('credit') || desc.includes('dividend')) return "Income";
    return "General";
  }, []);
